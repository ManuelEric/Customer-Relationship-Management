...
Route::prefix('teacher-counselor')->name('teacher-counselor.')->group(
    function () {
        Route::get('{teacher-counselor}/status/{status}', [ClientTeacherCounselorController::class, 'updateStatus'])->name('update.status');
    }
);
