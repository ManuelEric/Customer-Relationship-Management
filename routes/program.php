...
Route::get('event/referral/{refcode}/{event}', [ClientEventController::class, 'referralPage'])->name('program.event.referral-page')->withoutMiddleware(['auth', 'auth.department']);
