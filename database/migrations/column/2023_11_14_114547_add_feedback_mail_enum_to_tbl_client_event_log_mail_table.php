...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('tbl_client_event_log_mail', function (Blueprint $table) {
            DB::statement("ALTER TABLE tbl_client_event_log_mail MODIFY `category` ENUM ('thanks-mail', 'qrcode-mail', 'qrcode-mail-referral', 'reminder-registration', 'reminder-referral', 'reminder-attend', 'invitation-mail', 'thanks-mail-after', 'feedback-mail')");
        });
    }
