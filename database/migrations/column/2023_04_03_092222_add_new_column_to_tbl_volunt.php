...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('tbl_volunt', function (Blueprint $table) {
            $table->String('volunt_cv')->after('volunt_npwp');
            ...
            $table->string('volunt_bpjs_kesehatan')->nullable()->after('volunt_npwp');
            $table->string('volunt_bpjs_ketenagakerjaan')->nullable()->after('volunt_npwp');
        });
    }
