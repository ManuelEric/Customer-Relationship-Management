<div>
    ...
    <div class="card mb-3">
        ...
        <div class="card-body overflow-auto">
            <table class="table table-bordered table-hover nowrap align-middle w-100">
                ...
                <tbody>
                    @forelse($user->editor_agreement as $role_stream)
                        @php
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                {{ $role_stream->start_date ? date('d, M Y', strtotime($role_stream->start_date)) : 'n/a' }}
                            </td>
                            <td class="text-center">
                                {{ $role_stream->end_date ? date('d, M Y', strtotime($role_stream->end_date)) : 'n/a' }}
                            </td>
                            <td>{{ $role_stream->category ?? 'n/a' }}</td>
                            ...
                            <td class="text-center">
                                <button type="button" class="btn btn-sm btn-warning"
                                    ...
                                    data-bs-target="#agreementForm"><i class="bi bi-pencil"></i></button>
                                <button type="button" class="btn btn-sm btn-danger ms-1" x-data
                                    @click.prevent="if (confirm('Are you sure you want to delete? This cannot be undone.')) { $wire.delete({{ $role_stream->id }}) }"><i
    ...
    <div class="modal modal-md fade" id="agreementForm" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="live" wire:submit.prevent="{{ $isEdit ? 'update' : 'store' }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <select wire:model="category" @if (!$isEdit)  @endif
                                    ...
                                    @forelse ($categories as $key => $item)
                                        <option value="{{ $item }}">
                                            {{ $item ? $item : 'Select Category' }}</option>
                                    @empty
                            ...
                            <div>
                                <div class="row px-3 py-2">
                                    <fieldset class="border p-3">
                                        <legend class="float-none ps-2"
                                            style="width:80px; font-size: 14px; font-weight:500">Duration</legend>
                                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input class="form-control form-control-sm rounded" type="number"
                                    wire:model="fee_individual" placeholder="230625">
                            ...
                            <div class="col-md-6 mb-2">
                                <label for="">Agreement File @if (!$isEdit)
                                        <sup class="text-danger">*</sup>
                                    @endif
                                </label>
                                <div class="file-agreement">
                                    <input type="file" wire:model="agreement"
                                        class="form-control form-control-sm rounded">
                                </div>
                                @error('agreement')
                                    <small class="text-danger fw-light">{{ $message }}</small>
                            ...
                            <div class="col-md-12 mt-2">
                                <div class="d-flex justify-content-between">
                                    <button type="button" wire:click="resetFields"
                                        class="btn btn-sm btn-outline-danger rounded-3" data-bs-dismiss="modal">
                                    ...
                                    <div>
                                        ...
                                        <button type="submit" wire:loading.attr="disabled"
                                            wire:target="edit,agreement" class="btn btn-sm btn-primary rounded-3">
