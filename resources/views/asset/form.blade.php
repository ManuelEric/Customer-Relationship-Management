...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <a href="{{ url('asset') }}" class="text-decoration-none text-muted">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-2">
                                    ...
                                    <select name="asset_condition" class="form-select form-select-sm rounded">
                                        <option value="Good"
                            ...
                            <div class="col-md-12">
                                <div class="mb-2">
                                    ...
                                    <textarea name="asset_notes" cols="30" rows="5" class="form-control form-control-sm rounded">{{ isset($asset->asset_notes) ? $asset->asset_notes : old('asset_notes') }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
