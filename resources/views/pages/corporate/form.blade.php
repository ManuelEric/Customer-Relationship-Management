...
@section('content')
                        ...
                        @foreach ($pics as $pic)
                            <div class="list-group-item">
                                <div class="d-flex align-items-center mb-1">
                                    ...
                                    <div class="">
                                        <a href="#" onclick="returnData('{{ $corporate->corp_id }}','{{ $pic->id }}')" class="text-decoration-none"
                                            data-bs-target="#picForm">
                                            <i class="bi bi-pencil text-warning"></i>
                                        </a>
                                        <a href="#" onclick="confirmDelete('instance/corporate/{{ $corporate->corp_id }}/detail', '{{ $pic->id }}')" class="text-decoration-none">
    ...
    <div class="modal modal-md fade" id="picForm" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('corporate.detail.store', ['corporate' => $corporate->corp_id]) }}" id="detailForm" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-2">
                                    <label for="">Full Name</label>
                                    <input type="text" name="pic_name" id="pic_name" class="form-control form-control-sm rounded">
                                    @error('name')
                                        <small class="text-danger fw-light">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input type="email" name="pic_mail" id="pic_mail" class="form-control form-control-sm rounded">
                                    @error('email')
                                        <small class="text-danger fw-light">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="pic_phone" id="pic_phone" class="form-control form-control-sm rounded">
                                    @error('phone')
                                        <small class="text-danger fw-light">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="pic_linkedin" id="pic_linkedin" class="form-control form-control-sm rounded">
                                    @error('linkedin')
                                        <small class="text-danger fw-light">{{ $message }}</small>
                                    @enderror
                                </div>
    ...
    <script type="text/javascript">
        ...
        function resetForm() {
            ...
            $("#detailForm").attr('action', "{{ route('corporate.detail.store', ['corporate' => $corporate->corp_id]) }}")
