...
<div class="d-flex justify-content-between align-items-center">
    <ul class="nav nav-tabs flex-nowrap w-100 overflow-auto">
        ...
        <li class="nav-item" style="cursor: pointer" onclick="dashboardTab('partnership','partner-program')">
            <div class="nav-link text-nowrap partnership partner-program">Partnership Program</div>
        </li>
        <li class="nav-item" style="cursor: pointer" onclick="dashboardTab('partnership','program-comparison')">
            <div class="nav-link text-nowrap partnership program-comparison">Program Comparison</div>
        </li>
        <li class="nav-item" style="cursor: pointer" onclick="dashboardTab('partnership','client-event')">
            <div class="nav-link text-nowrap partnership client-event">Client Event</div>
        </li>
    </ul>
</div>
