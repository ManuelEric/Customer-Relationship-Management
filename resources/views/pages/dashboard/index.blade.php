...
@section('content')
    ...
    {{-- General --}}
    @includeWhen(
        $alarmLeads['general']['mid']['target'] || $alarmLeads['general']['mid']['event'],
        'pages.dashboard.alarm')
    ...
    {{-- Sales --}}
    @includeWhen(Request::segment(2) == 'sales' && ($isSuperAdmin || $isSalesAdmin || $isSales),
        'pages.dashboard.sales.index')

    {{-- Partnership --}}
    @includeWhen(Request::segment(2) == 'partnership' && ($isSuperAdmin || $isPartnership),
        'pages.dashboard.partnership.index')

    {{-- Digital  --}}
    @includeWhen(Request::segment(2) == 'digital' && ($isSuperAdmin || $isSalesAdmin || $isDigital),
        'pages.dashboard.digital.index')

    {{-- Finance  --}}
    @includeWhen(Request::segment(2) == 'finance' && ($isSuperAdmin || $isFinance),
        'pages.dashboard.finance.index')
...
@push('scripts')
    <script type="text/javascript" async>
        ...
        function dashboardTab(type, tab, reload = true) {
            ...
            if (reload) {
                window.location.href = '/dashboard/' + type + '/' + tab
            }
            return
        }
