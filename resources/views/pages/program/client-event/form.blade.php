                    ...
                    <form action="{{ url(isset($edit) ? 'program/event/' . $clientEvent->clientevent_id : 'program/event') }}" method="POST">
                        ...
                        <div class="row">
                                            ...
                                            <div class="status-mentee d-none">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-2">
                                                        ...
                                                        <select name="sch_id" id="schoolName" class="select w-100" onChange="addSchool();">
                                                            <option data-placeholder="true"></option>
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    ...
                                                    <select class="select w-100" name="st_levelinterest"  id="levelInterest">
                                                        <option data-placeholder="true"></option>
                                                        <option value="High" 
                                    ...
                                    @if (isset($ext_edufair) && count($ext_edufair) > 0)
                                        @foreach ($ext_edufair as $edufair)
                                            <option value="{{ $edufair->id }}"
                                                @if (isset($clientEvent->edufLead->id))
                                                {{ $clientEvent->edufLead->id == $edufair->id ? "selected" : null }}
                                                @else
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="date" name="joined_date" value="{{ isset($clientEvent) ? $clientEvent->joined_date : date('Y-m-d') }}"      
                            ...
                            <div class="col-md-6 mb-2">
                                <label>Status <sup class="text-danger">*</sup></label>
                                <select name="status" id="" class="select w-100" {{ empty($clientEvent) || isset($edit) ? '' : 'disabled' }}>
                                    @if(isset($clientEvent))
                                        <option value="0" {{ $clientEvent->status == '0' ? 'selected' : '' }}>Join</option>
                                        <option value="1" {{ $clientEvent->status == '1' ? 'selected' : '' }}>Attend</option>
                                    @else
