                    ...
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-end d-flex align-items-center">
                            ...
                            <i class="bi bi-trash2 text-danger cursor-pointer ms-2"
                                onclick="confirmDelete('program/corporate/{{ strtolower($partner->corp_id) }}/detail/{{ $partnerProgram->id }}/speaker', '{{ $speaker->agenda_id }}')">
                    ...
                    action="{{ url('program/corporate/' . strtolower($partner->corp_id) . '/detail/' . $partnerProgram->id . '/speaker') }}" method="POST" id="formPosition">
                     ...
                     <div class="row g-2">
                         ...
                         <div class="col-md-6 mb-2">
                             ...
                             <input type="datetime-local" name="start_time" id="" min="{{ $partnerProgram->start_date . 'T00:00' }}" max="{{ $partnerProgram->end_date . 'T00:00' }}"
                         ...
                         <div class="col-md-6 mb-2">
                             ...
                             <input type="datetime-local" name="end_time" id="" min="{{ $partnerProgram->start_date . 'T00:00' }}" max="{{ $partnerProgram->end_date . 'T23:59' }}"
                                 class="form-control form-control-sm">
                                 @error('end_time')
                                    <small class="text-danger fw-light">{{ $message }}</small>
                                @enderror
