            ...
            <div class="card-body pending-tutoring-container">
                <div class="row mb-2">
                    ...
                    <div class="col-md-12 mb-2 pending-tutoring-subject-tutoring-field d-none">
                        <small>Package <sup class="text-danger">*</sup></small>
                        <x-forms.program.detail.package program-type="subject-tutoring" text-index="0" :disabled=$disabled :client-program=$clientProgram />
                    </div>
                    <div class="col-md-12 mb-2 pending-tutoring-subject-tutoring-field curriculum-box d-none">
                        ...
                        <x-forms.program.detail.curriculum program-type="subject-tutoring" text-index="0" :disabled=$disabled :client-program=$clientProgram />
                    </div>

                    <!-- Detail for Competition -->
                    <div class="col-md-12 mb-2 pending-tutoring-competition-field d-none">
                        <small>Package <sup class="text-danger">*</sup></small>
                        <x-forms.program.detail.package program-type="competition" text-index="0" :disabled=$disabled :client-program=$clientProgram />
                    </div>

                    <!-- Detail for Skillset Tutoring -->
                    <div class="col-md-12 mb-2 pending-tutoring-skillset-tutoring-field d-none">
                        <small>Package <sup class="text-danger">*</sup></small>
                        <x-forms.program.detail.package program-type="skillset-tutoring" text-index="0" :disabled=$disabled :client-program=$clientProgram />
                    </div>
