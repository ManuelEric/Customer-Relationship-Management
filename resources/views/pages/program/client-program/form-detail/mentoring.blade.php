            ...
            <div class="card-body">
                ...
                <div class="row mb-2 mentor-ic">
                    <div class="col-md-12 mb-2">
                        ...
                        <select name="mentor_ic" id="" class="select w-100"
                            {{ $disabled }}>
                            <option data-placeholder="true"></option>
                            @foreach ($mentors as $mentor)
                                <option value="{{ $mentor->id }}"
                                    @if (old('mentor_ic') == $mentor->id) {{ 'selected' }}
                                    @elseif (isset($clientProgram->mentorIC) && $clientProgram->mentorIC()->orderBy('tbl_mentor_ic.id', 'asc')->count() > 0)
                ...
                <div class="row mb-2" v-if="status==1">
                    <div class="col-md-12 mb-2">
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <textarea id="installment_notes" class="form-control" name="installment_notes" {{ $disabled }}>
@if (old('installment_notes')){{ old('installment_notes') }}
