            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="input-group input-group-sm mb-1">
                    ...
                    <input type="number" name="invb2b_price" id="invoice_other_price" class="form-control"
                        ...
                        value="{{ (isset($invoicePartner)) ? $invoicePartner->invb2b_price : old('invb2b_price') }}"
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="input-group input-group-sm mb-1">
                    <input type="number" name="invb2b_participants_other" id="invoice_other_participant" class="form-control"
                        oninput="checkInvoiceOther()"
                        value="{{ (isset($invoicePartner)) ? $invoicePartner->invb2b_participants : old('invb2b_participants_other') }}"
                        {{ empty($invoicePartner) || $status == 'edit' ? '' : 'disabled' }}>
                    <span class="input-group-text" id="basic-addon1">
                        Person
                    </span>
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="input-group input-group-sm mb-1">
                    ...
                    <input type="number" name="invb2b_disc" id="invoice_other_discount" class="form-control"
                        oninput="checkInvoiceOther()"
                        value="{{ (isset($invoicePartner)) ? $invoicePartner->invb2b_disc : old('invb2b_price') }}"
                        {{ empty($invoicePartner) || $status == 'edit' ? '' : 'disabled' }}>
                    @error('invb2b_disc')
                        <small class="text-danger fw-light">{{ $message }}</small>
                    @enderror
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="input-group input-group-sm mb-1">
                    ...
                    <input type="number" name="invb2b_totprice" id="invoice_other_total" class="form-control"
                        value="{{ (isset($invoicePartner)) ? $invoicePartner->invb2b_totprice : old('invb2b_totprice') }}"
                        {{ empty($invoicePartner) || $status == 'edit' ? '' : 'disabled' }}>
