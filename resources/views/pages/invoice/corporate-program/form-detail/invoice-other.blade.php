        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <div class="input-group input-group-sm">
                    ...
                    <input type="number" name="invb2b_priceidr_other" id="invoice_other_price_idr" class="form-control" 
                        value="{{ (isset($invoiceSch)) ? $invoiceSch->invb2b_priceidr : old('invb2b_priceidr_other') }}" readonly
                        {{ empty($invoicePartner) || $status == 'edit' ? '' : 'disabled' }}>
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="input-group input-group-sm">
                    ...
                    <input type="number" name="invb2b_discidr_other" id="invoice_other_discount_idr" class="form-control" 
                        value="{{ (isset($invoiceSch)) ? $invoiceSch->invb2b_discidr : old('invb2b_discidr_other') }}" readonly
                        {{ empty($invoicePartner) || $status == 'edit' ? '' : 'disabled' }}>
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="input-group input-group-sm">
                    ...
                    <input type="number" name="invb2b_totpriceidr_other" id="invoice_other_total_idr" class="form-control" 
                        value="{{ (isset($invoiceSch)) ? $invoiceSch->invb2b_totpriceidr : old('invb2b_totpriceidr_other') }}" readonly
                        {{ empty($invoicePartner) || $status == 'edit' ? '' : 'disabled' }}>
            ...
            <div class="col-md-8 mb-3">
                ...
                <input type="text" name="invb2b_words" id="invoice_other_word"
                    ...
                    value="{{ (isset($invoiceSch)) ? $invoiceSch->invb2b_words : old('invb2b_words') }}" readonly
                    {{ empty($invoicePartner) || $status == 'edit' ? '' : 'disabled' }}>
                @error('invb2b_words')
                    <small class="text-danger fw-light">{{ $message }}</small>
                @enderror
                <input type="text" name="invb2b_wordsidr_other" id="invoice_other_word_idr"
                    ...
                    value="{{ (isset($invoiceSch)) ? $invoiceSch->invb2b_wordsidr : old('invb2b_wordsidr_other') }}" readonly
                    {{ empty($invoicePartner) || $status == 'edit' ? '' : 'disabled' }}>
