        ...
        <table width="100%" class="table-detail" style="padding:8px 5px;">
            ...
            <tr>
                ...
                <td valign="top" align="center">
                    <div style="min-height:80px;">
                        <p>
                            <strong>
                                {{ $bundle->invoice_b2c->invoice_price_idr }}
                            </strong>
                        </p>
                    </div>
                </td>
            ...
            @if ($bundle->invoice_b2c->inv_earlybird_idr > 0)
                <tr>
                    ...
                    <td valign="middle" align="center">
                        <b>{{ $bundle->invoice_b2c->invoice_earlybird_idr }}</b>
                    </td>
                </tr>
            @endif
            @if ($bundle->invoice_b2c->inv_discount_idr > 0)
                <tr>
                    ...
                    <td valign="middle" align="center">
                        <b>{{ $bundle->invoice_b2c->invoice_discount_idr }}</b>
                    </td>
                </tr>
            @endif
            <tr>
                ...
                <td valign="middle" align="center">
                    <b>{{ $bundle->invoice_b2c->invoice_totalprice_idr }}</b>
                </td>
            </tr>
        </table>

    <p style="text-align: right; padding-right: 5px;">
        Updated On: {{ date('d/m/Y H:i:s', strtotime($bundle->invoice_b2c->created_at)) }}
    </p>
        ...
        <tr>
            <td>
                <b style="letter-spacing:0.7px;"><i>Total Amount :
                        {{ $bundle->invoice_b2c->inv_words_idr }}</i></b>
                <br><br>
            </td>
        </tr>
    </table>
