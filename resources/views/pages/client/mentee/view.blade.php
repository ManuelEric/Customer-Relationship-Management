...
@section('content')
            ...
            <div class="card rounded mb-2">
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                        ...
                        <div class="">
                            <a href="#edit" class="btn btn-warning btn-sm rounded"><i class="bi bi-pencil"></i></a>
                        </div>
                    </div>
                    <hr>
            ...
            <div class="card rounded">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="">
                            <a href="#" class="btn btn-sm btn-primary">Add Program</a>
                        </div>
                    </div>
                    <hr>
    ...
    <!-- Modal -->
    <div class="modal modal-lg fade" id="menteeDetail" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Michael Nathan</h1>
