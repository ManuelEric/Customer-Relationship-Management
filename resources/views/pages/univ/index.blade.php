                ...
                <div class="modal-body w-100">
                    <form
                        ...
                        <div class="mb-2">
                            ...
                            <div class="w-100">
                                <select name="univ_country" id="univ" class="w-100">
                        ...
                        <div class="mb-2">
                            ...
                            <textarea name="univ_address" class="form-control form-control-sm rounded" style="height: 300px">{{ isset($university->univ_address) ? $university->univ_address : old('univ_address') }}</textarea>
                        </div>
                        <hr>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#univTable tbody').on('click', '.editUniv ', function() {
                ...
                window.location.href = "{{ url('master/university') }}/" + data.univ_id + '/edit';
            });
