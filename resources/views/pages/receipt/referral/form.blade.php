...
@section('content')
                    ...
                    <div class="card-body position-relative h-auto pb-5">
                        ...
                        <div class="text-center">
                            ...
                            <section class="step-indicator">
                                <div
                                    class="step step1 {{ $receiptRef->download_idr == 1 || $receiptAttachmentSigned || isset($receiptAttachmentNotYet) ? 'active' : '' }}">
                                    <div class="step-icon">1</div>
                                    <p>Download</p>
                                </div>
                                <div
                                    class="indicator-line {{ $receiptRef->download_idr == 1 || $receiptAttachmentSigned || isset($receiptAttachmentNotYet) ? 'active' : '' }}">
                                </div>
                                <div
                        ...
                        @if ($invoiceRef->currency != 'idr')
                            <div class="text-center mt-5">
                                ...
                                <section class="step-indicator">
                                    ...
                                    <div class="indicator-line {{ $receiptRef->download_other == 1 ? 'active' : '' }}">
                                    </div>
                                    <div
    ...
    <script>
            ...
            $("#export_other").on('click', function(e) {
                ...
                axios
                    ...
                    .then(response => {
                        ...
                        @php
                            $file_name = str_replace('/', '-', $receiptRef->receipt_id) . '-' . 'other' . '.pdf';
                        @endphp
            ...
            $("#export_idr").on('click', function(e) {
                ...
                axios
                    ...
                    .then(response => {
                        ...
                        @php
                            $file_name = str_replace('/', '-', $receiptRef->receipt_id) . '-' . 'idr' . '.pdf';
                        @endphp
        ...
        function requestAcc(currency) {
            ...
            showLoading();
            var url = '{{ url("/") }}/receipt/referral/{{ $receiptRef->id }}/request_sign/'+currency;
