            ...
            <table class="table table-bordered table-hover nowrap align-middle w-100" id="tbl_ref_in">
                ...
                <tfoot>
                    <tr>
                        ...
                        <th>$. {{ number_format($referrals_in->where('currency', 'USD')->sum('revenue_other')) }}
                        </th>
                        <th>S$. {{ number_format($referrals_in->where('currency', 'SGD')->sum('revenue_other')) }}
                        </th>
                        <th>£. {{ number_format($referrals_in->where('currency', 'GBP')->sum('revenue_other')) }}
                        </th>
                        <th></th>
                        <th></th>
                    </tr>
