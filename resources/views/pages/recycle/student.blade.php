...
<script>
    ...
    $(document).ready(function() {
        ...
        var table = $('#clientTable').DataTable({
            ...
            columns: [{
                ...
                // },
                {
                    data: '',
                    className: 'text-center',
                    defaultContent: '<button type="button" class="btn btn-sm btn-outline-success restore" onclick=""><i class="bi bi-arrow-counterclockwise"></i></button>'
                }
            ],
        ...
        $('#clientTable tbody').on('click', '.restore ', function() {
            ...
            confirmRestore('recycle/client/restore/students', data.id)
        });
