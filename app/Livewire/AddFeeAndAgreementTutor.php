...
class AddFeeAndAgreementTutor extends Component
{
    ...
    public $user_subject_id;

    public $curriculums = ['IBDP', 'IB MYP', 'Cambridge ALevel', 'Cambridge IGCSE', 'Advanced Placement', 'National', 'SAT', 'Competition']; // this curriculums has to be same as curriculums from timesheet database
