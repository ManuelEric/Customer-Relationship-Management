...
class StoreClientEventEmbedRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'child_name' => 'required_if:user_type,Student|nullable',
            'email' => 'required_if:user_type,Parent|nullable|email',
            'phone' => 'required_if:user_type,Parent|nullable|min:10|max:15',
            'email_child' => 'required_if:user_type,Student|nullable|email',
            'phone_child' => 'required_if:user_type,Student|nullable|min:10|max:15',
            'school' => 'required',
