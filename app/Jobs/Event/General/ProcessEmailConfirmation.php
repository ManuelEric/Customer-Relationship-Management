...
class ProcessEmailConfirmation implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            } elseif ($this->client_event->clientMaster->roles->where('role_name', 'Student')->first()) {
                $subject = 'Your '.$event_name.' Registration is Confirmed!';
                $role_name = 'Student';
            } elseif ($this->client_event->clientMaster->roles->where('role_name', 'Teacher/Counselor')->first()) {
