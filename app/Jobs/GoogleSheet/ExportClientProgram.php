    ...
    public function handle()
    {
        ...
        foreach ($clientProgs as $clientProg) {
            ...
            $data[] = [
                ...
                $this->replaceNullValue($clientProg['initconsult_date']) != '-' ? date('d/m/Y', strtotime($clientProg['initconsult_date'])) : '-',
                $this->replaceNullValue($clientProg['assessmentsent_date']) != '-' ? date('d/m/Y', strtotime($clientProg['assessmentsent_date'])) : '-',
                $this->replaceNullValue($clientProg['first_discuss_date']) != '-' ? date('d/m/Y', strtotime($clientProg['first_discuss_date'])) : '-',
                $this->replaceNullValue($clientProg['failed_date']) != '-' ? date('d/m/Y', strtotime($clientProg['failed_date'])) : '-',
                $this->replaceNullValue($clientProg['success_date']) != '-' ? date('d/m/Y', strtotime($clientProg['success_date'])) : '-',
                $this->replaceNullValue($clientProg['created_at']) != '-' ? date('d/m/Y', strtotime($clientProg['created_at'])) : '-',
            ];
            $i++;
        }
