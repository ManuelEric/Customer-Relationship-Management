...
interface ClientRepositoryInterface
{
    ...
    /* new */
    public function getNewLeads($asDatatables, $month, array $advanced_filter); // month nullable

    public function getPotentialClients($asDatatables, $month, array $advanced_filter); // month nullable

    public function getExistingMentees($asDatatables, $month, array $advanced_filter); // month nullable

    public function getExistingNonMentees($asDatatables, $month, array $advanced_filter); // month nullable
    ...
    public function getParents($asDatatables, $month, array $advanced_filter);

    public function getTeachers($asDatatables = false, $month = null);

    public function getClientHotLeads($initialProgram);

    public function getUnverifiedStudent($asDatatables, $month, array $advanced_filter);

    public function getUnverifiedParent($asDatatables, $month, array $advanced_filter);

    public function getUnverifiedTeacher($asDatatables, $month, array $advanced_filter);

    public function getInactiveStudent($asDatatables, $month, array $advanced_filter);

    public function getInactiveParent($asDatatables, $month, array $advanced_filter);

    public function getInactiveTeacher($asDatatables, $month, array $advanced_filter);
    ...
    // Raw Client
    public function getAllRawClientDataTables($roleName, $asDatatables, array $advanced_filter);
