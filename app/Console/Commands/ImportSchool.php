...
class ImportSchool extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($schools as $school) {
            ...
            if (!$schoolIdV2 && !$schoolNameV2 && $school->sch_id != null && $school->sch_name != null && $school->sch_name != "") {

                $new_schools[] = [
                    'sch_id' => $school->sch_id,
                    'sch_name' => $school->sch_name,
                    'sch_type' => $school->sch_type,
                    'sch_mail' => $school->sch_mail,
                    'sch_phone' => $school->sch_phone,
                    'sch_insta' => $school->sch_insta,
                    'sch_city' => $school->sch_city,
                    'sch_location' => $school->sch_location,
                    'sch_score' => 0,
