...
class SendReminderExpirationContractForEditor extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:reminder_expiration_contracts_editor';
     ...
     * @var string
     */
    protected $description = 'Sending a reminder to HR Team if there are employees (editor) contract that must be renewed or almost finished.';
    ...
    {
        Log::info('Cron send reminder expiration contract editor working properly');
        ...
        try {
            ...
            Log::error('Failed to send expiration contract (editor) to HR Team caused by : ' . $e->getMessage() . ' | Line ' . $e->getLine());
