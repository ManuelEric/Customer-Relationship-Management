...
class ImportEditor extends Command
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            foreach ($editors as $editor) 
            {
                ...
                $selectedUser = $this->createUserIfNotExists($editor);
    ...
    private function createUserIfNotExists($editor)
    {
        $extended_id = $editor->editor_id;
    ...
    private function attachEditorEducationsIfNotExists($editor, $user)
    {
    ...
    private function attachEditorRolesIfNotExists($editor, $user, $extended_id)
    {
